...
<style>
    .guide{position:absolute;top:0;left:0;width: 100%;height: 100%;background: url("../../assets/images/logo_bg.jpg")center no-repeat;background-size: cover;z-index: 2;box-shadow: 4px 0px 8px 0 rgba(0,0,0,.3);overflow: hidden;}
