<template>
    <div class="home" style="height: 100%;">
                        ...
                        <li v-for="item in hotelList">
                            <router-link :to="{path:'/s_home',query:{hotelid:item.hotelId, pageType:'unlogin', page:'unlogin'}}">
                                <div class="pic_show" @click="goHome(item)">
                                    ...
                                    <img :src="homeData.indexBackground">
                                </div>
                            </router-link>
                            <div class="address">
                                <div class="left">
                                ...
                                <div class="right">
                                    <router-link :to="{path:'/booking',query:{bookUrl:item.bookurl}}"><button type="button">{{language.apartment.book}}</button></router-link>
                                </div>
                            </div>
        ...
        <yd-actionsheet :items="myItems1" v-model="tabLanShow" cancel="Cancel"></yd-actionsheet>
        ...
        created:function () {
	        ...
	        this.$store.dispatch('getGroupListById', paramsById).then((res) => {
		        ...
		        for(var item in this.hotelList){
			        this.hotelList[item].distance=parseFloat(getDistance(localStorage.lat, localStorage.lng,res.data.list[item].lat,res.data.list[item].lng)).toFixed(1);
		        }
