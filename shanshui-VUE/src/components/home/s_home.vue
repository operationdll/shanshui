    ...
    <div class="home">
        <section class="index">
            ...
            <yd-navbar title="" class="index_tab">
                ...
                <router-link :to="{path:'/loginforguest'}" slot="left">
            ...
            <scroller ref="scroller">
                <section class="index_top" :style="{backgroundImage: 'url(' + homeData.indexBackground + ')'}">
                    ...
                    <h4 class="user_name" v-else>
                        <router-link :to="{path:'/loginforguest'}">Visitor</router-link>
                    </h4>
                    ...
                    <!-- 暂时关闭自助服务，后期改为app内部互动服务模块 -->
                    <div class="smart_home">
                        <button type="button" @click="goService()">{{shortcutList[0].title}}</button>
                    </div>
        ...
        <yd-actionsheet :items="myItems" v-model="tabLanShow2" cancel="Cancel"></yd-actionsheet>
        <!--底部菜单、个人中心、 设置项-->
        <v-foot></v-foot>
...
import n_home from "../home/n_home.vue";
export default {
  data() {
    return {
      menuFlag: false,
